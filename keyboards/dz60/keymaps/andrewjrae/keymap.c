...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE_L] = LAYOUT_60_ansi(MY_ESC,     KC_1,    KC_2,    KC_3,   KC_4,    KC_5,       KC_6,       KC_7,     KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,
                              ...
                              LT(NAV_L, KC_ESC), KC_A,    KC_S,    KC_D,   KC_F,    KC_G,       KC_H,       KC_J,     KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
                              MY_LSFT,    KC_Z,    KC_X,    KC_C,   KC_V,    KC_B,       KC_N,       KC_M,     KC_COMM, KC_DOT,  KC_SLSH, MY_RSFT,
                              MY_LCTL,    MY_LGUI, MY_LALT, KC_SPC, MY_RALT, OSL(NAV_L), OSL(NAV_L), MY_RCTL),
    ...
    [NUM_L] = LAYOUT_60_ansi(TO(BASE_L), KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7, KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS,
                             KC_TRNS,    KC_NO,   KC_BTN3, KC_NO,   KC_NO,   MY_TLDA, KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_TRNS,
                             KC_TRNS,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,  KC_8,    KC_9,    KC_0,    KC_NO,   KC_TRNS,
                             KC_TRNS,    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_GRV,  KC_NO,   KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case MY_ESC:
        if (record->event.pressed) {
            ...
            // Clear all mods and layers
            cleared_state |= get_oneshot_locked_mods();
            unregister_mods(get_oneshot_locked_mods());
            cleared_state |= layer_state_is(NAV_L);
